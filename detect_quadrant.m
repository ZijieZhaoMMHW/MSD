    ...
    for y=vmsd_start:vmsd_end
        ...
        if length(precip_year)==12
            if lat_here>0
                ...
                precip_clim_o=precip_clim_here(7);
                ...
                precip_clim_o=precip_clim_here(1);
            ...
            BI_here(:,:,y-vmsd_start+1)=BF.*((precip_a+precip_b-2*precip_o)./(precip_clim_a+precip_clim_b-2*precip_clim_o));
